...
export default function Comment() {
    ...
    const submitComment = (e) => {
        ...
        const cmt = {
            ...
            body: bodyInput.current?.value?.trim() || "",
        }

        if (!cmt.name || !cmt.email || !cmt.body) return
    ...
    if (isLoading) return <p className={styles.loading}>Đang tải…</p>
    ...
    return (
        <section className={styles.wrapper}>
            {comments.map((item) => (
                <article key={item.id} className={styles.card}>
                    <div className={styles.row}>
                        ...
                        <p className={styles.title} title={item.email}>
                            {item.email}
                        </p>
                    </div>
                    <p>{item.body}</p>
            ...
            <form
                className={`${styles.form} ${isSuccess ? styles.formSent : ""}`}
                onSubmit={submitComment}>
                {isSuccess && <div className={styles.success}>Đã gửi bình luận ✅</div>}
                ...
                <div className={styles.formGroup} style={{ gridTemplateColumns: "auto" }}>
                    <button
                        type="submit"
